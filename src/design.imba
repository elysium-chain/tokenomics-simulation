	...
	<self>
		<.header>
			...
			<.speed>
				<.icon-box>
					<Settings>
				<.input-box>
					<input[bgs: {(trans + 5)*10}% 100%] type='range' bind=trans min=-5 max=5 step=1>
				<h1> "{trans}"
		...
		<.section>
			<.scheme>
				<.info>
					<h2> '0.001 RAY'
						<span> 'RAY per transaction'
					<h2> '95000000'
						<span> 'SKY remain'
					<h2> '12890.0000'
						<span> "Validator's daily reward, SKY"
				<.empty>
				# Grinder
				<.blocks[gc: 3 / 4 gr: 1 / 6]>
					...
					<.block>
						<.title>
							<h2> "{SpaceNum(tcns.sky.rate.toFixed(2))} SKY"
								<span> 'SKY Burned'
							<.hint>
					...
					<.block>
						<.title>
							<h2> "{SpaceNum(tcns.sky.rate.toFixed(2))} RAY"
								<span> 'RAY Dealer'
							<.hint>
							<.hint-text> "Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year?"
						<(tcns.#charts.rate).chart>
				<.empty>
				# Fees
				<.block>
					<.title>
				...
				<.block.rainbow>
					<.title>
						<h2> "{SpaceNum(tcns.sky.supply.toFixed(0))} SKY"
				...
				<.block>
					<.title>
						<h2> "{SpaceNum(tcns.trx.total.toFixed(0))}"
							<span> 'Transactions'
						<.hint>
						<.hint-text> "Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year?"
				...
				<.block>
					<.title>
						<h2> "{SpaceNum(tcns.nodes.reward.toFixed(0))} RAY"
							<span> 'Rewards'
						<.hint>
						<.hint-text> "Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year?"
				...
				<.block.rainbow>
					<.title>
						<h2> "{SpaceNum(tcns.ray.supply.toFixed(0))} RAY"
				...
				<.block.last>
					<.title>
						<h2> "{SpaceNum(tcns.sky.rate.toFixed(4))} RAY"
							<span> '1 SKY'
						<.hint>
						<.hint-text> "Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year? Let's do something useful! 🙂 What will be the inflation during the 4-th year?"
					<(tcns.#charts.empty).chart.grid>
